...
namespace RecruitmentManager.Services.Controllers
{
    ...
    public class HardSkillsController : ControllerBase
    {
        ...
        [HttpPut]
        public async Task<bool> Put([FromBody] HardSkill hardSkill)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<bool> Delete(int hardSkillId)
        {
            return await _hardSkillCore.DeleteHardSkillAsync(hardSkillId);
        }
    }
}
